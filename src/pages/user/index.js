                                        ...
                                        <form className="row" onSubmit={handleSubmit}>
                                            ...
                                            <div className="col-4 mb-3">
                                                ...
                                                <input
                                                    ...
                                                    id="tanggalAdd"
                                                    value={tanggalAdd}
                                                    onChange={(e) => settanggalAdd(e.target.value)}
                                                />
                                            </div>
                            ...
                            <div className="riwayat">
                                <div className="card">
                                    <div className="card-body d-flex">
                                        <div className="text">
                                            <h5 className="card-title">{formData.namaUser}</h5>
                                            <p className="card-text">{formData.jenisSampah}</p>
                                            <p className="card-text">Berat: {formData.berat} kg</p>
                                            <p className="card-text">Harga: {formData.harga}</p>
                                            <p className="card-text">Poin: {formData.poin}</p>
                                            <p className="card-text">Tanggal: {formData.tanggalAdd}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
